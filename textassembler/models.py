...
class limits(models.Model):
    ...
    weekday_start_time = models.DateTimeField()
    weekday_end_time = models.DateTimeField()
    weekend_start_time = models.DateTimeField()
    weekend_end_time = models.DateTimeField()
